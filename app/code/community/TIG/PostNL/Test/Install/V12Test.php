 ...
 */
class TIG_PostNL_Test_Install_V12Test extends TIG_PostNL_Test_Framework_TIG_Test_TestCase
{
    public function attributesProvider()
    {
        return array(
            array('postnl_verification_type'),
        );
    }
    ...
    {
        return array(
            array('postnl_core/order', 'verification_type', 'varchar'),
            array('postnl_core/order', 'verification_number', 'text'),
            array('postnl_core/order', 'verification_expiration_date', 'date'),
        );
    }
