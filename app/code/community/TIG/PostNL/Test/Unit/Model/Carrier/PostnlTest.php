...
class TIG_PostNL_Test_Unit_Model_Carrier_PostnlTest extends TIG_PostNL_Test_Unit_Framework_TIG_Test_TestCase
{
    ...
    public function collectRatesProvider()
    {
        ...
        $extraAtHomeErrorMessage = 'This product(s) can only be delivered within the Netherlands or Belgium.';
        ...
        return array(
            ...
            array(true, null, 'UK', true, 'extra_at_home', $extraAtHomeErrorMessage),
            array(true, null, 'NL', false, 'extra_at_home', true),
            array(true, null, 'BE', false, 'extra_at_home', true),
        );
    }
