 ...
 */
class TIG_PostNL_Model_DeliveryOptions_Observer_Onepage extends Varien_Object
{
    /**
    ...
    public function addDeliveryOptions(Varien_Event_Observer $observer)
    {
         ...
         */
        $block->setTemplate('TIG/PostNL/checkout/onepage/shipping_method/available.phtml');
