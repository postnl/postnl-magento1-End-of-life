 ...
 */
class TIG_PostNL_OrderController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    public function printReturnLabelAction()
    {
        ...
        try {
            ...
            $this->_redirect('postnl/order/returns', array('order_id' => $postnlShipment->getOrderId()));
            return $this;
        } catch (Exception $e) {
            $helper->logException($e);
